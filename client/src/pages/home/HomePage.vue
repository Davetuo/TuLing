...
function goHotDestination(city: string) {
  router.push({ name: 'Spots', query: { city } })
}
      ...
      <section class="shortcuts">
        ...
        <div class="shortcut-section">
          ...
          <div class="empty-block">
            ...
            <el-button type="primary" size="small" @click="router.push({ name: 'Trips' })">
              开始规划
            </el-button>
          </div>
        </div>
        ...
        <div class="shortcut-section">
          ...
          <div class="empty-block">
            ...
            <el-button type="primary" size="small" @click="router.push({ name: 'Chat' })">
              开始提问
            </el-button>
          </div>
        </div>
